...
describe('iterate_X function test', function() {
    ...
    it('tests after calculate_units() for ally when searching enemy on ally.y = enemy.y = (1) and ally.x = 170', function () {
        var ally_formation =  [{color: 'red',  dmg: 10, hp: 100, column: 10, row: 10, x: 170, y: 1 }];
        var enemy_formation = [{color: 'blue', dmg: 10, hp: 100, column: 10, row: 10, x: 220, y: 1 }];
        var first_mocked_unit  = new Unit(1100, 1, 100, 'blue', -1, 5, 5, 10, false);
    ...
    it('tests after initiate() for enemy when searching ally on enemy.y = ally.y = (1) and enemy.x = 220', function () {
        var ally_formation =  [{color: 'red',  dmg: 10, hp: 100, column: 10, row: 10, x: 170, y: 1 }];
        var enemy_formation = [{color: 'blue', dmg: 10, hp: 100, column: 10, row: 10, x: 220, y: 1 }];
        var core = new Core(ally_formation, enemy_formation, unit_width, distance_x, distance_y, ctx, randomnr);
        core.initiate();
    ...
    it('tests after calculate_units() for enemy when searching ally on enemy.y = ally.y = (1) and enemy.x = 220', function () {
        var ally_formation =  [{color: 'red',  dmg: 10, hp: 100, column: 10, row: 10, x: 170, y: 1 }];
        var enemy_formation = [{color: 'blue', dmg: 10, hp: 100, column: 10, row: 10, x: 220, y: 1 }];
        var core = new Core(ally_formation, enemy_formation, unit_width, distance_x, distance_y, ctx, randomnr);
        core.initiate();
